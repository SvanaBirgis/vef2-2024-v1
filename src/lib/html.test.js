...
import { indexTemplate, leikirTemplate, template } from './html';
...
<html lang="is">
  ...
  describe('generate leikir template', () => {
    it('generates correct leikir template', async () => {
...
<html lang="is">
  ...
  describe('generate stada template', () => {
    it('generates correct stada template', async () => {
      const courses = [{ title: 'foo' }];
      const result = leikirTemplate("stodur");
